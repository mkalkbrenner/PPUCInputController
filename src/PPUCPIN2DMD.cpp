        ...
        if (deviceByte != 0) {
            ...
            if (eventByte != 0) {
                ...
                if (nullByte == 0) {
                    ...
                    // the PPUC will be the only Device attached to PIN2DMD. But as the device must must not be "0", we
                    ...
                    // Editor.
                    eventDispatcher->dispatch(new PPUCEvent(EVENT_SOURCE_DMD, word((deviceByte & B1111111) - 100, eventByte)));
