...
void PPUCSolenoids::registerJ126(byte pin, byte number) {
    if      (pin == 1)  { registeredNum[14] = number; }
    else if (pin == 2)  { registeredNum[15] = number; }
    else if (pin == 3)  { registeredNum[16] = number; }
...
void PPUCSolenoids::registerJ110(byte pin, byte number) {
}

void PPUCSolenoids::registerJ111(byte pin, byte number) {
}

void PPUCSolenoids::registerJ9(byte pin, byte number) {
}

void PPUCSolenoids::registerP11(byte pin, byte number) {
}

void PPUCSolenoids::registerP12(byte pin, byte number) {
}

//helps with debugging
void PPUCSolenoids::print() {
	for (int i = 0; i < NUM_PINS; i++) {
